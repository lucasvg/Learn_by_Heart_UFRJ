...
*/
public class UserTypeDao extends AbstractDao<UserType, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, UserType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(UserType entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(UserType entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(UserType entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
