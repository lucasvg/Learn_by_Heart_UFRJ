...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        MeaningDao.createTable(db, ifNotExists);
        ExampleDao.createTable(db, ifNotExists);
        NotificationDao.createTable(db, ifNotExists);
        LogExampleNotificationDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        MeaningDao.dropTable(db, ifExists);
        ExampleDao.dropTable(db, ifExists);
        NotificationDao.dropTable(db, ifExists);
        LogExampleNotificationDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MeaningDao.class);
        registerDaoClass(ExampleDao.class);
        registerDaoClass(NotificationDao.class);
        registerDaoClass(LogExampleNotificationDao.class);
    }
